...
./cws_large -d data-list.txt -r covtype.scale01.rnd -m 54 -s 32 -b 2 -i 1 -w 1 -l 1 -t 4

echo -e "\n#### Step 7. Concatenate the sub sampled data. ####"
find $PWD/split-data/*.cws > cws-list.txt
./concatenate -d cws-list.txt -o covtype.scale01.32.2.cws

echo -e "\nGood job!! You obtained the sampled dataset covtype.scale01.32.2.cws as follows:"
head covtype.scale01.32.2.cws
echo "..."
