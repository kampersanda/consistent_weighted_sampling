...
./bin/topk_search -i news20/news20.scale_base.cws.bvecs -q news20/news20.scale_query.cws.bvecs -o news20/news20.scale_score -b 8 -d 64
echo ""

echo "(7) Evaluate the recall"
python scripts/topk_evaluate.py news20/news20.scale_score.topk.8x64.txt news20/news20.scale_groundtruth.txt
echo ""
